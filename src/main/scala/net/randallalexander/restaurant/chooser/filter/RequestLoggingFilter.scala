package net.randallalexander.restaurant.chooser.filter
...
/**
  * Stolen from finchtemplate.http.RequestLoggingFilter and tweaked for simple.
  *
...
abstract class RequestLoggingFilter[REQ <: Request](val log: Logger, val formatter: FinagleLogFormatter[REQ, Response])
  ...
  def logSuccess(replyTime: Duration, request: REQ, reply: Response): Unit = {
...
object RequestLoggingFilter extends RequestLoggingFilter[Request](LoggerFactory.getLogger("access"), new FinagleCommonLogFormatter)